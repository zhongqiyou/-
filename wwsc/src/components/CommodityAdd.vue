<template>
  <div>
    ...
    <ul class="commodity_text">
      <van-cell-group>
        <van-field v-model="shop" center clearable label="店铺名称：" placeholder="请输入店铺名称"></van-field>
      </van-cell-group>

      <van-cell-group>
        <van-field v-model="primary" center clearable label="商品原价：" placeholder="请输入原价价钱"></van-field>
      </van-cell-group>

      <van-cell-group>
        <van-field v-model="price" center clearable label="商品价钱：" placeholder="请输入商品价钱"></van-field>
      </van-cell-group>

      <van-cell-group>
        <van-field v-model="discount" center clearable label="商品折扣：" placeholder="请输入商品折扣"></van-field>
      </van-cell-group>

      <van-cell-group>
        <van-field v-model="volume" center clearable label="商品月销：" placeholder="请输入商品月销"></van-field>
      </van-cell-group>
