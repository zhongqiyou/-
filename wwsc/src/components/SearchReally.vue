<template>
        <div>
            ...
            <div class="search_list">
                ...
                <ul>
                    <li v-for="(value , index) in search_list" :key="index" v-on:click="onTitleOne(value)">
                         {{value}} 
                    </li>        
                </ul>
            </div>
             ...
             <div class="search_list">
                ...
                <ul>
                    <li v-for="(value , index) in search_list_history" :key="index" v-on:click="onTitleTne(value)">
                          {{value}}
                        </li>        
                </ul>
            </div>
...
export default {
             data() {
                 return {
                     value:"" ,
                     search_list:["踢脚线" , "帮宝适" , "羽绒服" , "跑步鞋" , "手机" , "牛奶" , "洗发水" , "电视" , "零食" , "ipad" , "洗衣服" , "洗衣液"] ,
                       search_list_history:[] ,
                 }
             },
            methods: {
                ...
                onInsert(){
                      this.axios.get('/wwsc/search/insert.php', {
                        params: {
                        record: this.value
                        }
                    })
                .then( (res) => {
                        ...
                        this.$router.push({path:'/commodity',query: {text:this.value}})
                    });
                } , 
                onDelete(){
                     this.axios.get('/wwsc/search/delete.php')
                                .then((res)=>{
                                window.console.log(res);
                ...
                onSelect(){
                     this.axios.get('/wwsc/search/select.php')
                    .then((res)=>{
